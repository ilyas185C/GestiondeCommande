...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-edit fa-fw me-2"></i>Modifier Commande #{{ $commande->id }}
        </h1>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control @error('date_commande') is-invalid @enderror" 
                               id="date_commande" name="date_commande" value="{{ old('date_commande', $commande->date_commande->format('Y-m-d')) }}" required>
                        @error('date_commande')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('etat_commande') is-invalid @enderror" id="etat_commande" name="etat_commande" required>
                            <option value="en cours" {{ $commande->etat_commande == 'en cours' ? 'selected' : '' }}>En cours</option>
